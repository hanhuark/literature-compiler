...
Flat copper water pool boiling is often a baseline case inside enhanced-surface studies. The search should not depend on exact title or keyword matches such as "boiling curve" or "flat copper". Useful search terms include:

- `"pool boiling" water copper`
...
Include papers likely to contain one or more data series for:

- water, deionized water, distilled water, or double-distilled water;
- saturated or near-saturated pool boiling;
- atmospheric pressure or approximately 1 bar;
- plain, smooth, bare, untreated, polished, or reference copper surfaces;
- flat horizontal samples where possible.

Enhanced-surface papers are acceptable candidates when they include a plain/smooth/untreated copper baseline curve.

## Exclusion Or Lower-Priority Criteria

Lower priority or exclude:

- copper tubes, wires, cylinders, or curved surfaces unless they are useful for context only;
- nanofluids or mixtures unless a pure-water copper baseline is shown;
- subcooled, transient, low-pressure, high-pressure, or flow-boiling studies unless they include a directly comparable baseline;
- papers reporting only CHF without a boiling curve, unless useful for citation chasing.

## First-Pass Candidate Groups

### High-Priority Candidate Data Sources

These are likely to contain digitizable or reported boiling-curve data for a plain/smooth/untreated copper baseline.
...
These sources are especially useful for finding older baseline studies and understanding scatter across nominally similar flat copper water tests.
